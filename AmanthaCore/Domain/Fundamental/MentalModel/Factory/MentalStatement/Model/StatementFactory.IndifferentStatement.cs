...
namespace AmanthaCore.Domain.Fundamental.Abstractions.Factory
{
    ...
    {
        private class IndifferentStatement : IMentalStatement
        {
            public IEnumerable<IMentalStatementProperty> Properties { get; set; }

            public MentalStatementType Type { get; private set; } = MentalStatementType.Indifferent;
            internal IndifferentStatement()
            {
