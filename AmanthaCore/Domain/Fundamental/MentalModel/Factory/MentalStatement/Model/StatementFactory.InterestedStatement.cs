...
namespace AmanthaCore.Domain.Fundamental.Abstractions.Factory
{
    ...
    {
        private class InterestedStatement : IMentalStatement
        {
            public IEnumerable<IMentalStatementProperty> Properties { get; set; }

            public MentalStatementType Type { get; private set; } = MentalStatementType.Interested;

            internal InterestedStatement()
            {
